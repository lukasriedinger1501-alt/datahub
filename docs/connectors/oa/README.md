...
| 连接器 | 类型 | 功能特点 | 文档状态 |
| ------ | ---- | -------- | -------- |
| [钉钉](dingtalk.md) | 移动办公平台 | 审批流、考勤、组织架构、消息推送 | ✅ 稳定 |
| [飞书](lark.md) | 协同办公套件 | 审批、多维表格、日历、即时通讯 | ✅ 稳定 |
| [企业微信](wecom.md) | 企业通讯工具 | 审批流、打卡、客户管理、应用消息 | ✅ 稳定 |
| [泛微 e-cology](weaver-ecology.md) | 专业 OA 系统 | 工作流、知识管理、协同办公 | ✅ 稳定 |
| [泛微 e-office](weaver-eoffice.md) | 中小企业 OA | 轻量级审批、文档管理 | ✅ 稳定 |
| [蓝凌 EKP](landray-ekp.md) | 知识管理平台 | 流程管理、知识库、协同办公 | ✅ 稳定 |
| [致远 OA](seeyon-oa.md) | 协同管理系统 | 表单流程、公文管理、移动办公 | ✅ 稳定 |
| [道一云](daoyiyun.md) | 企业微信生态 | 七巧低代码、表单流程、数据集成 | ✅ 稳定 |
| [氚云](chuanyun.md) | 低代码平台 | 表单设计、流程引擎、API 开放 | ✅ 稳定 |
| [简道云](jiandaoyun.md) | 零代码应用 | 表单搭建、流程审批、数据分析 | ✅ 稳定 |
| [汇联易](huilianyi.md) | 费控报销平台 | 费用报销、审批流、财务集成 | ✅ 稳定 |
