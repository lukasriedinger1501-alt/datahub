...
- [适配器开发指南](adapter-development.md) — 了解 PHP/JavaScript 适配器开发
- [自定义连接器开发](custom-connector.md) — 开发自定义连接器
- [SDK 使用](sdk.md) — 平台官方 SDK 文档
- [调试与测试](debugging-testing.md) — 调试技巧和测试方法
