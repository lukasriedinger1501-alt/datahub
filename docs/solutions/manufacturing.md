...
- [MES 与 ERP 集成方案](mes-erp.md) - 详细的 MES 与 ERP 对接指南
- [MES 集成标准方案](../standard-plans/mes-standard.md) - 开箱即用的 MES 集成模板
- [WMS 集成标准方案](../standard-plans/wms-standard.md) - 仓储系统集成方案
- [央国企采购平台对接](government-procurement.md) - 采购业务集成方案
