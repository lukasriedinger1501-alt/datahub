...
- [金蝶连接器](../connectors/erp/kingdee-cloud-galaxy.md) - 金蝶云星空连接器配置
- [用友连接器](../connectors/erp/yonyou-bip.md) - 用友 BIP 连接器配置
- [SAP 集成指南](../developer/sap-integration.md) - SAP 系统集成指南
- [制造业解决方案](../solutions/manufacturing.md) - 制造业 ERP 集成场景
